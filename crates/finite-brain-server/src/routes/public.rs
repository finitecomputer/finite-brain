...
const PRODUCT_CLIENT_APP_SCRIPT_TAG: &str =
    r#"<script src="/client/app.js?v=20260707-member-details"></script>"#;
...
pub(crate) async fn product_client_handler(State(state): State<ServerState>) -> impl IntoResponse {
    ...
    <script src="/client/app.js?v=20260707-member-details"></script>
    <script src="/client/smoke-nip07.js?v=20260707-member-details"></script>"#,
        );
    }
